...
type StoryCombinedWeekElement = HTMLElement & { events: Map<string, WeekStoryEvent> };

const meta: Meta = {
  title: "CalendarView/CombinedWeek",
  component: "combined-week",
  tags: ["autodocs"],
  parameters: {
  ...
  render: (args) => {
    const el = document.createElement("combined-week") as StoryCombinedWeekElement;
