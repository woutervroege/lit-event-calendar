...
import type { CalendarEventView, CalendarRecurrenceRule } from "../../types/CalendarEvent.js";
...
function toRRuleOptions(
  ...
  const options: Options = {
    ...
    wkst: recurrenceRule.wkst ? WEEKDAY_BY_CODE[recurrenceRule.wkst] : undefined,
    ...
    count: "count" in recurrenceRule ? recurrenceRule.count : undefined,
    until:
