const sharedButtonBaseClasses =
  "inline-flex h-9 items-center rounded-lg [--_lc-button-bg-default:light-dark(rgb(255_255_255_/_94%),rgb(255_255_255_/_24%))] [--_lc-button-hover-bg-default:light-dark(rgb(255_255_255_/_98%),rgb(255_255_255_/_30%))] [--_lc-button-checked-bg-default:var(--_lc-button-bg-default)] [--_lc-button-checked-hover-bg-default:var(--_lc-button-hover-bg-default)] [--_lc-button-border-color:light-dark(var(--_lc-grid-line-color,rgb(15_23_42_/_14%)),var(--_lc-grid-line-color,rgb(255_255_255_/_16%)))] border border-solid border-[var(--_lc-button-border-color)] text-sm leading-5 text-[light-dark(rgb(15_23_42_/_72%),rgb(255_255_255_/_72%))] transition-colors duration-200";
